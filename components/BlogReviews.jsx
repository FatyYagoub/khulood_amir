...
const BlogReviews = ({ blogId, slug, isLogged }) => {
...
const AddReview = ({ mutate, setLoading, loading, blogId }) => {
  const router = useRouter();
            ...
            InputProps={{
              startAdornment: (
                <InputAdornment position="start">
                  <div className="w-10 h-10 rounded-full mx-2 border border-grey flex justify-center items-center ">
                    <img
